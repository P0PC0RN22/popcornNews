...
class VideoArticleDetails2 extends StatefulWidget {
  final Article? data;
  const VideoArticleDetails2({Key? key, required this.data})
      : super(key: key);

  @override
  _VideoArticleDetails2State createState() => _VideoArticleDetails2State();
}

class _VideoArticleDetails2State extends State<VideoArticleDetails2> {
